...
import com.pekall.emdm.launcher.FolderIcon.FolderRingAnimator;
...
public class Workspace extends SmoothPagedView
    ...
    */
    ...
    public boolean onEnterScrollArea(int x, int y, int direction) {
        Log.i(TAG, "onEnterScrollArea x:" + x + ", y:" + y + ", direction:" + direction);
    ...
    void hideItems(final ArrayList<String> packageNames) {
    ...
    public void getLocationInDragLayer(int[] loc) {
        Log.i(TAG, "getLocationInDragLayer: ");
        mLauncher.getDragLayer().getLocationInDragLayer(this, loc);
        Log.d(TAG, String.format("getLocationInDragLayer loc[0]=%s, loc[1]=%s", loc[0], loc[1]));
    }
