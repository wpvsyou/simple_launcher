...
import com.pekall.emdm.launcher.LauncherSettings.Favorites;
...
import static com.pekall.emdm.launcher.R.attr.className;
import static com.pekall.emdm.launcher.R.attr.container;
import static com.pekall.emdm.launcher.R.attr.packageName;
import static com.pekall.emdm.launcher.R.attr.screen;

public class LauncherProvider extends ContentProvider {
    static final String AUTHORITY = "com.pekall.emdm.launcher.settings";
    ...
    /**
     * {@link android.net.Uri} triggered at any registered {@link android.database.ContentObserver} when
     * {@link android.appwidget.AppWidgetHost#deleteHost()} is called during database creation.
     * Use this to recall {@link android.appwidget.AppWidgetHost#startListening()} if needed.
     */
    ...
    private static LauncherProvider sInstance;
    private DatabaseHelper mOpenHelper;
    private Context mContext;

    public static void setLaucherProvier() {
        LauncherApplication.getInstance().setLauncherProvider(sInstance);
    }
...
//        LauncherApplication.getInstance().setLauncherProvider(this);
        mContext = getContext();
        sInstance = this;
        return true;
    }
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        /**
         * Now we don't find an interface to query based on package name
         *
         * @return
         */
        public static final String ACTION_PEKALL_MAIN = "pekall.intent.action.MAIN";
        ...
        /**
         * Send notification that we've deleted the {@link android.appwidget.AppWidgetHost},
         * probably as part of the initial database creation. The receiver may
         * want to re-call {@link android.appwidget.AppWidgetHost#startListening()} to ensure
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            // - Passion shipped on 2.1 with version 6 of launcher
        ...
        private int loadFavorites(SQLiteDatabase db, int workspaceResourceId) {
            ...
            try {
                ...
                addAppShortcut(db, values, packageManager, intent);
        ...
        public List<ResolveInfo> queryInstalledActivities() {
            ...
            List<ResolveInfo> systemApps = packageManager.queryIntentActivities(intent, 0);
            intent.setAction(ACTION_PEKALL_MAIN);
            List<ResolveInfo> pekallApps = packageManager.queryIntentActivities(intent, 0);
            systemApps.addAll(pekallApps);
            List<ResolveInfo> thirdPartyApps = new ArrayList<ResolveInfo>(systemApps.size());
            for (ResolveInfo info : systemApps) {
                thirdPartyApps.add(info);
            }

            return thirdPartyApps;
        }

        private void addAppShortcut(SQLiteDatabase db, ContentValues values,/* TypedArray a,*/ PackageManager packageManager, Intent intent) {
            int x = 0;
            int y = 0;
            for (ResolveInfo resolveInfo : queryInstalledActivities()) {
                if (x == 5) {
                    x = 0;
                    y ++;
                }
                ...
                Log.i(TAG, "init CONTAINER_HOTSEAT comp name:" + cn.toString());
                ...
                long id = dbInsertAndCheck(this, db, TABLE_FAVORITES, null, values);
                Log.i(TAG, "id: " + id);
            }
        }
